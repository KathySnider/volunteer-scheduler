...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Query._authHealthCheck":
		if e.complexity.Query.AuthHealthCheck == nil {
			break
		}
...
var sources = []*ast.Source{
	{Name: "../schema.graphql", Input: `# Auth schema - public endpoint, no authentication required.

type Query {
  # gqlgen requires at least one query, so this is a placeholder.
  _authHealthCheck: Boolean
}
...
func (ec *executionContext) _Mutation_requestMagicLink(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNMagicLinkResult2ᚖvolunteerᚑschedulerᚋgraphᚋauthᚋgeneratedᚐMagicLinkResult,
		true,
		true,
	)
}
...
func (ec *executionContext) _Mutation_consumeMagicLink(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		nil,
		ec.marshalNAuthResult2ᚖvolunteerᚑschedulerᚋgraphᚋauthᚋgeneratedᚐAuthResult,
		true,
		true,
	)
}
...
func (ec *executionContext) _Query__authHealthCheck(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		ec.OperationContext,
		field,
		ec.fieldContext_Query__authHealthCheck,
		func(ctx context.Context) (any, error) {
			return ec.resolvers.Query().AuthHealthCheck(ctx)
		},
		nil,
...
func (ec *executionContext) fieldContext_Query__authHealthCheck(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	fc = &graphql.FieldContext{
		Object:     "Query",
		Field:      field,
		IsMethod:   true,
	...
	for i, field := range fields {
		...
		case "_authHealthCheck":
			...
			innerFunc := func(ctx context.Context, _ *graphql.FieldSet) (res graphql.Marshaler) {
				...
				res = ec._Query__authHealthCheck(ctx, field)
				return res
			}
...
func (ec *executionContext) marshalNAuthResult2volunteerᚑschedulerᚋgraphᚋauthᚋgeneratedᚐAuthResult(ctx context.Context, sel ast.SelectionSet, v AuthResult) graphql.Marshaler {
	return ec._AuthResult(ctx, sel, &v)
}

func (ec *executionContext) marshalNAuthResult2ᚖvolunteerᚑschedulerᚋgraphᚋauthᚋgeneratedᚐAuthResult(ctx context.Context, sel ast.SelectionSet, v *AuthResult) graphql.Marshaler {
	if v == nil {
...
func (ec *executionContext) marshalNMagicLinkResult2ᚖvolunteerᚑschedulerᚋgraphᚋauthᚋgeneratedᚐMagicLinkResult(ctx context.Context, sel ast.SelectionSet, v *MagicLinkResult) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
